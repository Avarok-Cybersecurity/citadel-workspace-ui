...
// The unified message/event/options types live in chat-messaging-types.ts;
// re-exported so existing import sites keep working.
import type { ChatMessage, ChatMessageEvent, SendMessageOptions } from './chat-messaging-types';
export type {
  ChatMessage,
  ChatMessageEvent,
  ChatMessageEventType,
  SendMessageOptions,
} from './chat-messaging-types';
