 ...
 */
export const CACHE_TTL_MS: 2000 = INTERVAL.HEARTBEAT_MS;
 ...
 */
export const MAX_RECONNECT_DELAY_MS: 10000 = TIMEOUT.P2P_ACCEPT_REQUEST_MS;

/**
 * Health check timeout before reconnection attempt (milliseconds).
 */
export const HEALTH_CHECK_TIMEOUT_MS: 5000 = TIMEOUT.SERVER_REQUEST_MS;

/**
 * Timeout for GetSessions request (milliseconds).
 */
export const GET_SESSIONS_TIMEOUT_MS: 10000 = TIMEOUT.CLAIM_SESSION_MS;

/**
 * Timeout for WebSocket initialization during startup (milliseconds).
 */
export const WEBSOCKET_INIT_TIMEOUT_MS: 3000 = TIMEOUT.SESSION_MANAGEMENT_MS;

/**
 * Timeout for setSelectedUser operation (milliseconds).
 */
export const SET_USER_TIMEOUT_MS: 3000 = TIMEOUT.SESSION_MANAGEMENT_MS;

/**
 * Delay after disconnect before reconnecting (milliseconds).
 */
export const POST_DISCONNECT_DELAY_MS: 500 = TIMEOUT.P2P_MESSAGE_MS;
