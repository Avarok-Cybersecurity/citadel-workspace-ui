    ...
    return (
      <Comp
        ...
        className={cn(
          ...
          showOnHover && "group-focus-within/menu-item:opacity-100 group-hover/menu-item:opacity-100 data-[state=open]:opacity-100 peer-data-[active=true]/menu-button:text-sidebar-accent-foreground [@media(hover:hover)_and_(pointer:fine)]:opacity-0",
          className
        )}
        {...props}
      />
