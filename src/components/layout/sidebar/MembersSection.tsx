          ...
          <div className="flex items-center justify-between px-3">
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <Button variant="ghost" size="sm" data-testid="new-group-chat-button" className="h-5 w-5 p-0 text-primary-accent hover:text-primary-foreground hover:bg-primary" onClick={() => setShowCreateGroupDialog(true)}>
